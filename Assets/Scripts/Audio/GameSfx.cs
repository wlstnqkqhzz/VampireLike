...
namespace VampireLike.Audio
{
    ...
    public class GameSfx : MonoBehaviour
    {
        ...
        private static readonly Dictionary<SfxType, string> ClipNames = new Dictionary<SfxType, string>
        {
            ...
            { SfxType.Boss7Teleport, "boss7_teleport" },
            { SfxType.Boss7CurseWarning, "boss7_curse_warning" },
            { SfxType.Boss7CurseExplosion, "boss7_curse_explosion" },
            { SfxType.Boss7HomingOrb, "boss7_homing_orb" },
            { SfxType.Boss7Summon, "boss7_summon" },
        ...
        private static readonly Dictionary<SfxType, float> MinIntervals = new Dictionary<SfxType, float>
        {
            ...
            { SfxType.Boss7Teleport, 0.15f },
            { SfxType.Boss7CurseWarning, 0.2f },
            { SfxType.Boss7CurseExplosion, 0.2f },
            { SfxType.Boss7HomingOrb, 0.12f },
            { SfxType.Boss7Summon, 0.2f },
        ...
        private static readonly Dictionary<SfxType, float> Volumes = new Dictionary<SfxType, float>
        {
            ...
            { SfxType.Boss7Teleport, 0.85f },
            { SfxType.Boss7CurseWarning, 0.7f },
            { SfxType.Boss7CurseExplosion, 1f },
            { SfxType.Boss7HomingOrb, 0.85f },
            { SfxType.Boss7Summon, 0.8f },
        ...
        private static readonly Dictionary<SfxType, Vector2> PitchRanges = new Dictionary<SfxType, Vector2>
        {
            ...
            { SfxType.Boss7Teleport, new Vector2(0.96f, 1.03f) },
            { SfxType.Boss7CurseWarning, new Vector2(0.95f, 1f) },
            { SfxType.Boss7CurseExplosion, new Vector2(0.96f, 1.01f) },
            { SfxType.Boss7HomingOrb, new Vector2(0.98f, 1.05f) },
            { SfxType.Boss7Summon, new Vector2(0.96f, 1.03f) },
